...
describe('Controller Tests', function() {
    ...
    describe('PgwPayModeMatch Management Detail Controller', function() {
        var $scope, $rootScope;
        var MockEntity, MockPreviousState, MockPgwPayModeMatch, MockPgwPortal, MockPgwPayMode, MockPgwProduct;
        ...
        beforeEach(inject(function($injector) {
            ...
            createController = function() {
                $injector.get('$controller')("PgwPayModeMatchPgwDetailController", locals);
            };
        }));
